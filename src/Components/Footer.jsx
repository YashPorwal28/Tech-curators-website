  ...
  return (
    <div className="bg-[#121619]">
      <div className="w-3/5 m-auto  ">
        <div className="footer_top flex flex-col gap-6 px-6 py-3 bg-[#0F2127] rounded-lg lg:flex-row pb-10 pt-10  lg:px-[100px] lg:items-center lg:justify-between">
          <div className="contactUs flex flex-col gap-4 mt-3    ">
